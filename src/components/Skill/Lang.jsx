...
const Lang = () => {
    return (
        <>
            <Box mt="5rem" w="100%" h='100vh' border="groove 10px #88fdfd" borderBottom="none">
            <Box
                    position="absolute"
                    width="99%"
                    height="100vh"
                ...
                <Box bg="#88fdfd42" border="groove 10px #88fdfd" textShadow="0 0 10px #46ffff68, 0 0 5px #46ffff67" color="#d0fefe" borderLeft="solid 12px #000000" borderRadius="10px" position="relative" w="30rem" h="6rem" display="flex" justifyContent="space-between" p="2rem" alignItems="center" ml="-0.75rem" mt="3rem" fontSize="2rem">
                    ...
                    <Text mt="20px" textShadow="0 0 10px #46ffff68, 0 0 5px #46ffff67" color="#d0fefe">LANGUAGES</Text>
                </Box>
                <Grid
                    padding="2rem"
                    h='83vh'
                ...
                css={animatedStyles} background="linear-gradient(to top, #2b808083, #000000)" mx="6rem" border="groove #88fdfd 5px" borderRadius="50%" _hover={{
                    ...
                    }} display="flex" flexDirection="column" justifyContent="space-around" alignItems="center" gap={3} >
                        <img src="./resources/c.png" alt="" height="120px" width="120px" />
                        <Text fontSize="1.3rem" fontWeight="bolder">C</Text>
                    </GridItem>
                    <GridItem rowSpan={1} colSpan={1} animation={`${scrollani} linear,${floatAnimation} 3s ease-in-out infinite`}
                css={animatedStyles} background="linear-gradient(to top, #2b808083, #000000)" mx="6rem" border="groove #88fdfd 5px" borderRadius="50%" _hover={{
                        borderRadius: "50%",
                ...
                css={animatedStyles} background="linear-gradient(to top, #2b808083, #000000)" mx="6rem" border="groove #88fdfd 5px" borderRadius="50%" _hover={{
                        ...
                        <img src="./resources/java.png" alt="" height="120px" width="120px" />
                        <Text fontSize="1.3rem" fontWeight="bolder">JAVA</Text>
                    </GridItem>
                    <GridItem rowSpan={1} colSpan={1} bg='#0000000' ></GridItem>
                    <GridItem rowSpan={1} colSpan={1} bg='#0000000' ></GridItem>
                    <GridItem rowSpan={1} colSpan={1} animation={`${scrollani} linear,${floatAnimation} 3s ease-in-out infinite`}
                css={animatedStyles} background="linear-gradient(to top, #2b808083, #000000)" mx="6rem" border="groove #88fdfd 5px" borderRadius="50%" _hover={{
                        ...
                        <img src="./resources/python.png" alt="" height="120px" width="120px" />
                        <Text fontSize="1.3rem" fontWeight="bolder">PYTHON</Text>
                    </GridItem>
                    <GridItem rowSpan={1} colSpan={1} bg='#0000000' ></GridItem>
                    <GridItem rowSpan={1} colSpan={1} animation={`${scrollani} linear,${floatAnimation} 3s ease-in-out infinite`}
                css={animatedStyles} background="linear-gradient(to top, #2b808083, #000000)" mx="6rem" border="groove #88fdfd 5px" borderRadius="50%" _hover={{
                ...
                css={animatedStyles} background="linear-gradient(to top, #2b808083, #000000)" mx="6rem" border="groove #88fdfd 5px" borderRadius="50%" _hover={{
                        ...
                        <img src="./resources/js.png" alt="" height="120px" width="120px" />
                        <Text fontSize="1.3rem" fontWeight="bolder">JavaScript</Text>
                    </GridItem>
                    <GridItem rowSpan={1} colSpan={1} bg='#0000000' ></GridItem>
